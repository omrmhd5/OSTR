...
const productsmen = [
  ...
  { id: 3, name: "Shirt 55", price: 299, image: "src/assets/shirt.jpeg" },
...
const productswomen = [
  ...
  { id: 9, name: "Shirt 55", price: 299, image: "src/assets/img1.jpg" },
...
export default function ShopPage() {
  const [selectedProducts, setSelectedProducts] = useState([...productsmen, ...productswomen]);
  ...
  return (
    <div className="p-4 bg-bg_clr text-t_clr font-paragraph [&_h1]:font-header [&_h2]:font-header [&_h3]:font-header [&_h4]:font-header [&_h5]:font-header [&_h6]:font-header">
      <header className="flex justify-between items-center border-b pb-2 mb-4">
        ...
        <div>
          <button className="mr-2 px-4 py-2 bg-bg_clr text-white" onClick={() => setSelectedProducts(productsmen)}>Men</button>
          <button className="px-4 py-2 bg-bg_clr text-white" onClick={() => setSelectedProducts(productswomen)}>Women</button>
        </div>
      </header>
      <div className="grid grid-cols-4 gap-4">
        {selectedProducts.map((product) => (
          <div key={product.id} className="text-center bg-cn_clr p-4 rounded">
            ...
            <p className="text-[--color-cn_cl]">${product.price}</p>
