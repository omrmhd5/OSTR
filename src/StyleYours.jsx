    ...
    <div className="bg-bg_clr w-full">
      <div className=" py-6 px-20 rounded-lg w-3/4 justify-self-center  bg-cn_clr text-t_clr  font-paragraph [&_h1]:font-header [&_h2]:font-header [&_h3]:font-header [&_h4]:font-header [&_h5]:font-header [&_h6]:font-header">
        <div className="flex justify-center items-center mt-20 text-6xl font-bold ">
          ...
          <Select>
            <SelectTrigger className="w-[200px] ml-5 mt-3 text-4xl bg-white h-[200px] cursor-pointer hover:animate-pulse">
        ...
        <div className="flex justify-center items-center mt-20 mb-20  ">
          <div className="p-4 w-full max-w-xs ml-10 mt-10  ">
            <h2 className="text-center text-2xl font-bold mb-4">Choose size</h2>
            <div className="divide-y divide-gray-300 ">
              ...
              <Button
                className="mt-4 ml-50 w-20 bg-gray-600 text-white py-2 rounded-md cursor-pointer "
                onClick={toggleModal}
              >
                Size Chart
              </Button>
              ...
              <Button
                className="mt-4 w-full bg-gray-600 text-white py-2 rounded-md cursor-pointer font-bold hover:animate-bounce"
