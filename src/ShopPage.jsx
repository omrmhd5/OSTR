...
const allProducts = [...productsmen, ...productswomen];
  ...
  return (
    <div className="p-4 bg-bg_clr text-t_clr font-paragraph [&_h1]:font-header [&_h2]:font-header [&_h3]:font-header [&_h4]:font-header [&_h5]:font-header [&_h6]:font-header">
      ...
      <div className="flex items-center justify-center ">
          <button className="mr-2 px-4 py-2 bg-bg_clr text-t_clr" onClick={() => setSelectedProducts(productsmen)}>Men</button>
          <button className="mr-2 px-4 py-2 bg-bg_clr text-t_clr" onClick={() => setSelectedProducts(productswomen)}>Women</button>
